...
def register_routes(app):
    ...
    def api_login():
        ...
        if not all([username, password]):
            return jsonify(utils.format_api_response_fail("Vui lòng nhập đầy đủ thông tin!")), 400
        ...
        try:
            ...
            if user:
                ...
                return jsonify(utils.format_api_response_fail("Tên đăng nhập hoặc mật khẩu không đúng!")), 401
        except ValueError as e:
            return jsonify(utils.format_api_response_fail(str(e))), 400
    ...
    def api_register():
        ...
        try:
            ...
            print(f"Lỗi đăng ký hệ thống: {str(e)}")
    ...
    def pay():
        ...
        if not booking_session or not expire_time or now >= expire_time:
            ...
            return redirect(
                url_for('booking', showtime_id=showtime.id, cinema_slug=cinema_slug, room_id=showtime.room_id))
    ...
    def process_payment():
        ...
        if payment_method == 'momo':
            ...
            # Gọi API MoMo
            momo_response = create_momo_payment(order_id, total_amount, order_info, redirect_url, ipn_url,
                                                expire_minutes)
    ...
    def my_tickets():
        ...
        return render_template('ticket.html', bookings=user_bookings, pages=total_pages, page=page,
                               page_range=page_range)
